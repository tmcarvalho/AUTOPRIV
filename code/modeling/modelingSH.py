...
This script will test the predictive performance of each data set with Successive Halving hyperparameter optimization.
"""
import warnings
import time
import pandas as pd
...
# %% evaluate a model
def evaluate_model_sh(x_train, x_test, y_train, y_test, args):
    """Evaluatation
    ...
    score_cv['opt_type'].append("Halving")
